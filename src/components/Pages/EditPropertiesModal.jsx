...
//       requestData.append("title", formValues.title.trim());
//       requestData.append("description", formValues.description.trim());
//       requestData.append("price", parseFloat(formValues.price)); // Convert to number
//       requestData.append("city", formValues.city);
//       requestData.append("country", formValues.country);
//       requestData.append("dimension", formValues.dimension);
//       requestData.append("latitude", parseFloat(formValues.latitude));
//       requestData.append("longitude", parseFloat(formValues.longitude));
//       requestData.append("municipality", formValues.municipality);
//       requestData.append("property_face", formValues.property_face);
//       requestData.append("province", formValues.province);
//       requestData.append("road_type", formValues.road_type);
//       requestData.append("type", formValues.type);
//       requestData.append("ward_no", parseInt(formValues.ward_no)); // Convert to integer
...
//         "Failed to update property. Network error.";
//       toast.error(message);
//       setErrorMessage(message);
//     } finally {
//       setIsSubmitting(false);
