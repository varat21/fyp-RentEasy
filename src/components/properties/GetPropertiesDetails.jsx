...
//       <Button  fullWidth variant="filled" size="lg" type="submit">
//           Book Now
//         </Button>
//       </div>
//       <RatingModal
...
const GetPropertyDetails = () => {
  ...
  const handleBooking = async () => {
    ...
    formData.append("property_id", id); // Use correct key name
    formData.append("id", property?.id); // Ensure correct user ID key
    formData.append("status", "pending"); // Add status
    formData.append("payment_status", "pending"); // Add payment status
