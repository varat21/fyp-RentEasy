...
const Header = () => {
  ...
  return (
<header className="bg-gray-100 shadow-sm w-full mx-auto sticky top-0 z-[9999] px-6 py-0 rounded-lg h-auto">
<div className="container mx-auto flex justify-between items-center py-2 px-2 md:px-12 lg:px-24">
        <Link to="/" className="flex flex-col items-center -ml-28">
          <img
            src="/images/logo.png"
            alt="RentEasy Logo"
            className="h-14"
